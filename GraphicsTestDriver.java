...
public class GraphicsTestDriver implements BoardGraphicsInf
{
    public static void main(String[] args)
    {
        ...
        gg.changeTileImage(23,"ANTAGONIST");
        gg.changeTileImage(20,"");

        String test = "HELLLLLO";
        gg.addTextToInfoArea(test);
        gg.toggleWallGraphic(20, GraphicsWallDirections.NORTH);
